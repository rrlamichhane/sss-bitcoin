...
def calculate_mersenne_primes() -> List[int]:
...
SMALLEST_257BIT_PRIME: int = 2**256 + 297
SMALLEST_321BIT_PRIME: int = 2**320 + 27
SMALLEST_385BIT_PRIME: int = 2**384 + 231
STANDARD_PRIMES: List[int] = calculate_mersenne_primes() + [
...
def get_large_enough_prime(batch: List[int]) -> Optional[int]:
